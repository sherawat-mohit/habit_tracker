...
// printing all the habits and their status on 'home' page
...
// adding a habit or creating a custom habit
module.exports.create=async function(req,res){
    try {
        let nameValue = (req.body.habits?req.body.habits:req.body.custom_habit);
        ...
        // setting the status of habit for a week
        for(let i=0;i<7;i++){
            let currentDate = new Date();
...
// to delete a habit using it's "ID"
